...
namespace Lab_2
{
    class MyString
    {
        ...
        public static bool operator >(MyString str1, MyString str2)           // Если все символы совпадают, то меньше та строка, которая имеет меньшую длину
        {
        ...
        public static bool operator ==(MyString str1, MyString str2)    // Строки равны, если их длина и все символы равны
        {
